...
nyc_cvrisk_joined = inner_join(nyc_cvrisk_limited, nyc_cad, by = "unique_id")
```
...
p = nyc_cvrisk_joined %>%  
  ...
  # gganimate parts
  transition_states(risk_factor, transition_length = 1, state_length = 50000, wrap = TRUE) +
  enter_fade() +
  exit_fade()

animate(p, fps = 1, height = 800, width = 800)
