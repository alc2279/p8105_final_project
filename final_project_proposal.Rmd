...
* Interactive Shiny tool that will allow patients to input their data, for example, age, sex and smoking history, and then visualize the changes in their risks.
=======
* Visualizations/statistical models showing associations between cardiovascular mortality and risk factors, including location specific (at the county level) visualizations
* Interactive Shiny tool that will allow patients to input their data (observe change in risk based on behavior/health changes)
>>>>>>> 0409cdfeace5d855d174af3d786c173d67796456
