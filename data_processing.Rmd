...
gganimate::gg_animate(g)

anim_save("./raw_data/animation.gif")
...
ggplot(nyc_cvrisk_joined, aes(data_value, chd_value,)) +
...
p <- 
  ...
  # gganimate parts
  transition_states(measure_id, transition_length = 10, state_length = 20)
